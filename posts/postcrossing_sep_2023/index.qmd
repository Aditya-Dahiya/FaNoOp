...
### Relation of postcards sent per member to the ageing of population in countries:
...
df |> 
  ...
  labs(y = "Average no. of postcards sent per member", 
       x = NULL,
       title = "Countries with more elderly population also send more postcards, on average",
       subtitle = "The converse is also true: more young people in the population correlates with lower number postcards per member") +
...
```{r}
#| label: postcrossers-top-100-last-60-days
...
Looking closely at the *postcrossers* who figure both in the **Top 100 of all time** and **Top 100 of last 60 days**
...
top_users |>
  ...
  scale_y_continuous(breaks = c(20, 10, 1)) +
  ...
  labs(x = NULL, 
       y = NULL,
       title = "In top-rankers, Americans are sending more postcards lately",
       subtitle = "Looking at the users who figure in both the all time top 100 and last 60 days top 100 ranks,\nwe find that Americans have moved up and Germans have fallen in ranks") +
